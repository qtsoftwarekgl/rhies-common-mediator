...
```
cd existing_repo
git remote add origin https://gitlab.com/rbc5/rhies-common-mediator.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rbc5/rhies-common-mediator/-/settings/integrations)
